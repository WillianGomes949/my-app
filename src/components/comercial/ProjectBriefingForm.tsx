                ...
                {serviceTypes.map((type) => (
                  ...
                  >
                    <input
                      ...
                      onChange={handleInputChange}
                      required
                      className="text-will-accent focus:ring-will-accent accent-will-accent w-4 h-4"
                    />
                ...
                {features.map((feature) => (
                  ...
                  >
                    <input
                      ...
                      className="text-will-accent focus:ring-will-accent rounded accent-will-accent w-4 h-4"
                    />
