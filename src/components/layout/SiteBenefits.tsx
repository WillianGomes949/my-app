  ...
  const benefits: BenefitItem[] = [
    {
      ...
      description: "Seu site perfeito em qualquer dispositivo - celular, tablet ou desktop, garantindo a melhor experiência para seus clientes.",
      color: "from-will-primary to-will-p-light"
    },
    {
      icon: <MdSpeed className="text-3xl" />,
      title: "Alta Performance",
      description: "Carregamento ultrarrápido que reduz a taxa de rejeição e aumenta a conversão, otimizado para SEO.",
      color: "from-will-secondary to-yellow-500"
    },
    {
      icon: <MdTrendingUp className="text-3xl" />,
      title: "Conversão Otimizada",
      description: "Layouts pensados para guiar o visitante até a ação desejada, aumentando vendas e contatos.",
      color: "from-will-accent to-green-400"
    },
    {
      icon: <MdSearch className="text-3xl" />,
      title: "SEO Avançado",
      description: "Estrutura técnica otimizada para ranqueamento no Google, atraindo clientes qualificados organicamente.",
      color: "from-blue-500 to-cyan-400"
    },
    {
      icon: <MdSecurity className="text-3xl" />,
      title: "Segurança Robustecida",
      description: "Proteção contra ameaças, SSL, backups automáticos e conformidade com LGPD para tranquilidade total.",
      color: "from-purple-600 to-pink-500"
    },
    {
      icon: <MdBarChart className="text-3xl" />,
      title: "Análises de Dados",
      description: "Integração com Google Analytics para entender seu público e tomar decisões baseadas em dados.",
      color: "from-orange-500 to-red-500"
    },
    {
      icon: <MdGroup className="text-3xl" />,
      title: "Experiência do Usuário",
      description: "Interface intuitiva que encanta visitantes e aumenta o tempo de permanência no site.",
      color: "from-teal-500 to-emerald-400"
    },
    {
      icon: <MdCheckCircle className="text-3xl" />,
      title: "Manutenção Contínua",
      description: "Suporte técnico, atualizações de segurança e melhorias para seu site sempre atualizado.",
      ...
      <div className="relative">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 py-16">
          <div className="bg-gray-800/50 backdrop-blur-sm rounded-xl p-6 text-center border border-gray-700 hover:border-will-primary transition-all duration-300">
            <div className="text-4xl font-bold font-montserrat text-will-primary mb-2">+80%</div>
          ...
          <div className="bg-gray-800/50 backdrop-blur-sm rounded-xl p-6 text-center border border-gray-700 hover:border-will-accent transition-all duration-300">
            <div className="text-4xl font-bold font-montserrat text-will-accent mb-2">24/7</div>
          ...
          <div className="bg-gray-800/50 backdrop-blur-sm rounded-xl p-6 text-center border border-gray-700 hover:border-will-secondary transition-all duration-300">
            <div className="text-4xl font-bold font-montserrat text-will-secondary mb-2">-40%</div>
          ...
          <div className="bg-gray-800/50 backdrop-blur-sm rounded-xl p-6 text-center border border-gray-700 hover:border-will-p-light transition-all duration-300">
            <div className="text-4xl font-bold font-montserrat text-will-p-light mb-2">5x</div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
          {benefits.map((benefit, index) => (
            ...
            >
              ...
              <div className={`absolute inset-0 bg-linear-to-br ${benefit.color} opacity-0 group-hover:opacity-10 transition-opacity duration-500`}></div>
              
              {/* Icon with gradient */}
              <div className={`inline-flex p-3 rounded-lg bg-linear-to-br ${benefit.color} mb-4 group-hover:scale-110 transition-transform duration-300`}>
              ...
              <p className="text-will-text-light">
                {benefit.description}
              </p>
